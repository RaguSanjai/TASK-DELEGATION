...
export const Home = () => {
  return (
    ...
    <div className="head">
  <div className="topname"><h1>Task Delegation </h1></div>
   <div className="content" style={{display : 'flex' ,textAlign:"justify"}} >
   <h3>⬛Why Is It Important to Delegate?<br></br>
   <br></br>⬛Why Managers Fail to Delegate?<br></br>
   <br></br>⬛How to Determine When Delegating is Appropriate.<br></br>
   <br></br>⬛How to Delegate Tasks Effectively.</h3></div>
